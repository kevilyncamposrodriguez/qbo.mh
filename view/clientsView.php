                ...
                <table id="data-table-select" class="table table-striped table-bordered table-td-valign-middle">
                    <thead>
                        <tr>
                            ...
                            <th class="text-nowrap">Realm ID QB</th>
                            <th class="text-nowrap">Refresh token</th>
                            <th class="text-nowrap">Usuario MH</th>
                            <th class="text-nowrap">Contraseña MH</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        foreach ($data as $value) {
                            echo '<td>'.$value['id'].'</td>';
                            echo '<td><a class="btn btn-default fa fa-trash" href="?controller=Default&action=deleteClient&idcard=' . $value['id'] . '"></a></td>';
                            echo '<td>' . $value['idcard'] . '</td>';
                            echo '<td>' . $value['realmId'] . '</td>';
                            echo '<td>' . $value['refreshToken'] . '</td>';
                            echo '<td>' . $value['userMH'] . '</td>';
                            echo '<td>' . $value['passMH'] . '</td>';
                            echo '</tr>';
                        }
                        ?>
