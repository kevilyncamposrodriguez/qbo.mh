...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Importar Notas de Crédito<small></small></h1>
<!-- end page-header -->
<!-- begin row -->
			<div class="row">
				<!-- begin col-12 -->
						...
						<div class="panel-body">
						    <div class="row">
                				...
                				<?php if(isset($vars)){
                                        ...
                                        <form method="POST"  action="?controller=CreditNote&action=import" enctype="multipart/form-data" name="LayoutGrid1">
                				...
                				<?php }else{ ?>
                				    <form class=" align-center" action="?controller=CreditNote&action=import" method="post" enctype="multipart/form-data" name="LayoutGrid1" >
                				        <div class="row">
                            				<!-- begin col-12 -->
                            				<div class="col-6">
        							...
        							<div class="row">
                        				<!-- begin col-12 -->
                        				<div class="col-12">
                							<a  href="files/Machotes/Machote NC.xlsx" download >
                                ...
                                <table id="data-table-select" class="table table-striped table-bordered table-td-valign-middle">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-nowrap">Consecutivo Ref</th>
                                        ...
                                        if(isset($vars["results"])){
                                            if($vars["results"]!=null && $vars["results"] !=''){
                                                ...
                                                foreach ($data as $value) {
                                                        ...
                                                        echo '<td>' . $value["consecutivoref"] . '</td>';
